...
{
    Task<List<TaskTypeReadOnlyVM>> GetAll(DateOnly? fromDate, DateOnly? toDate, TimeOnly? fromTime, TimeOnly? toTime, string? department, int? skillLevel, bool? allocated);
